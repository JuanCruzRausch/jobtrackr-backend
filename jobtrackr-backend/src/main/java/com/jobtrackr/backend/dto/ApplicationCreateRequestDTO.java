...
public record ApplicationCreateRequestDTO(
        ...
        @NotNull Boolean hasBonusRsu,
        @Size(max = 10_000) String bonusRsuDetails,

        @NotNull Boolean hasRaises,
        @Size(max = 10_000) String raisesDetails,

        @NotNull Boolean hasThirteenthSalary,

        @NotNull Boolean hasExtraBenefits,
        @Size(max = 10_000) String extraBenefitsDetails,

        @NotNull Boolean hasHealthInsurance,
        @Size(max = 10_000) String healthInsuranceDetails,

        @NotNull Boolean hasVacation,
        @Min(0) @Max(365) Integer vacationDays,

        @NotNull Boolean hasHolidays,
